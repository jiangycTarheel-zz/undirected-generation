...
class Evaluator(object):
    ...
    def create_reference_files(self):
        ...
        for (lang1, lang2), v in self.data['para'].items():
            ...
            assert lang1 < lang2 or lang1 == 'ro'
                ...
                for lang1, lang2 in set(params.mt_steps + [(l2, l3) for _, l2, l3 in params.bt_steps]):
                    ...
                    if params.encoder_only:
                        if params.predict_order:
                            lang_pair = params.order_pred_steps[0][0] + '-' + params.order_pred_steps[0][1]
                        else:
    ...
    def evaluate_mt(self, scores, data_set, src_lang, tgt_lang, lang_pair, \
        ...
        model.eval()
        model = model.module if (params.multi_gpu and not params.fp16) else model
